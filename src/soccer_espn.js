// src/soccer_espn.js
// Soccer fetcher. Writes popular-competition matches into today_games exactly
// like wnba_espn.js does for WNBA (espn_live.js is DO NOT TOUCH and does not
// export its upsert helper). Soccer is a full team sport: it reuses
// today_games / picks / mvp_picks, gets the +5 sport bonus and the +5 home
// bonus, and its slots are seeded by lines.js like any other team sport.
//
// Lines: ESPN's embedded DraftKings odds are free (no Odds API credits).
// Soccer is NOT in odds_api.js SPORT_KEY_MAP — never spend credits on it.
//
...
// Popular competitions only. World Cup first.
const SOCCER_PATHS = [
  'soccer/fifa.world',
