...
import { LOCK_SVG, PICK_HEAT_COLOR, fmtOdds, fmtSpread, gameTime, countryColorPair, isSuspendedGame, suspendedLabel } from './utils.js?v=10';
...
export const TEAM_COLORS = {
  ...
  // NHL
  // NFL (2026-07-28 — the map had zero football entries, so every NFL band and
  // gauge fell back to the same default pair; Jack: "football looks bland").
  ...
  'New Orleans Saints':    ['#101820','#D3BC8D'],
